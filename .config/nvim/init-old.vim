...
let g:coc_global_extensions = ['coc-prettier', 'coc-angular', 'coc-tsserver',  'coc-git', 'coc-json',  'coc-pairs', 'coc-highlight', 'coc-html', 'coc-css', 'coc-vetur', 'coc-snippets', 'coc-svelte', 'coc-eslint']
" Coc python tips
